...
function reportsSaleTableCreator(
  ...
  $("#customerNameFilter").val("").trigger("chosen:updated"); // clear selected customer name
  $("#vendorNameFilter").val("").trigger("chosen:updated"); // clear selected vendor name
  var tableContainerDivID = "#" + tableContainerDiv;
  var tableID = "#" + table;
  $(tableContainerDivID).load(tableCreatorFileUrl, function () {
    // Initiate the Datatable plugin once the table is added to the DOM
...
$("#saleDetailsItemName").change(function getItemDetailsToPopulateForSaleTab() {
  // Get the itemNumber entered in the text box
  var productName = $("#saleDetailsItemName").val();
  var defaultImageData =
    '<img class="img-fluid" src="data/item_images/imageNotAvailable.jpg">';

  // Call the getProductByName.php script to get item details
  // relevant to the itemNumber which the user entered
  $.ajax({
    url: "model/item/getProductByName.php",
    method: "POST",
...
$("#purchaseDetailsItemName").change(function getItemName() {
  var productName = $("#purchaseDetailsItemName").val();
  $.ajax({
    url: "model/item/getProductByName.php",
    method: "POST",
    data: { productName: productName },
    ...
    success: function (data) {
      ...
      $("#purchaseDetailsCurrentStock").val(data.stock);
    },
    error: function (xhr, ajaxOptions, thrownError) {
      console.log(xhr);
    },
...
function getCustomerDetailsToPopulate() {
  ...
  // Call the populateCustomerDetails.php script to get item details
  // relevant to the itemNumber which the user entered
  $.ajax({
...
$("#saleDetailsCustomerName").change(function () {
  var saleDetailsCustomerName = $("#saleDetailsCustomerName").val();
  $.ajax({
    url: "model/customer/getCustomerId.php",
    method: "POST",
    data: { customerName: saleDetailsCustomerName },
    dataType: "json",
    success: function (data) {
      $("#saleDetailsCustomerID").val(data);
    },
  });
});
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      $("#saleDetailsCustomerName")
        ...
        .trigger("chosen:updated");
      $("#saleDetailsItemName").val(data.itemName).trigger("chosen:updated");
