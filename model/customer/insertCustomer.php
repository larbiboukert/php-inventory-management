<?php
	...
	if(isset($_POST['customerDetailsCustomerFullName'])){
		...
		if(isset($fullName) && isset($mobile) && isset($address)) {
			...
			if($address == ''){
				// Adresse 1 is empty
				echo '<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert">&times;</button>Please enter Adresse 1</div>';
				exit();
			}
			...
			if($fullName == ''){
				// Full Name is empty
				echo '<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert">&times;</button>Please enter Nom.</div>';
				exit();
			}
			...
			echo '<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">&times;</button>Client added to database</div>';
		} else {
