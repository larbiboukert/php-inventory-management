	...
	if(isset($_POST['purchaseDetailsItemNumber'])){
		...
		if(isset($purchaseDetailsItemNumber) && isset($purchaseDetailsPurchaseDate) && isset($purchaseDetailsItemName) && isset($purchaseDetailsQuantity) && isset($purchaseDetailsUnitPrice)){
			...
			if($purchaseDetailsItemName == ''){ 
				echo '<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert">&times;</button>Please enter Nom Produit.</div>';
				exit();
			}
			
			// Check if quantity is empty
			if($purchaseDetailsQuantity == ''){ 
				echo '<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert">&times;</button>Please enter Quantité.</div>';
				exit();
			}
			...
			if($stockStatement->rowCount() > 0){
				...
				// Produit exits in the item table, therefore, start the inserting data to purchase table
				...
				// Produit does not exist in item table, therefore, you can't make a purchase from it 
